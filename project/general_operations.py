...
class FileProcessor:
    ...
    # def calculate_mean_median_mode(self, column):
...
class EPS:
    ...
    def convert(self, img):
        ...
        byte_stream = BytesIO()
        # Increase the quality of the EPS file by setting a higher resolution
        im.save(byte_stream, format='EPS', lossless=False, dpi=(300, 300))
        byte_stream.seek(0)
        save_dir = self.eps_dir # Use the class attribute for the save directory
